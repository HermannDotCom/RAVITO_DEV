...
export const AnnualKPIs: React.FC<AnnualKPIsProps> = ({ kpis, previousYearKPIs }) => {
  ...
  return (
    <div className="space-y-6">
      {/* Section Title */}
      <h2 className="text-xl font-bold text-slate-900">Indicateurs Clés de l'Année</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
          ...
          <h3 className="text-sm font-medium text-slate-600 mb-1">CA Total Annuel</h3>
        ...
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-5">
          ...
          <h3 className="text-sm font-medium text-slate-600 mb-1">Marge Brute</h3>
          <p className="text-2xl font-bold text-blue-900">{formatCurrency(kpis.grossMargin)} F</p>
          <p className="text-xs text-slate-500 mt-1">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {kpis.bestMonth && (
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-4 border border-green-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-medium text-green-800">Meilleur Mois</p>
            </div>
        ...
        {kpis.worstMonth && (
          <div className="bg-gradient-to-br from-slate-50 to-slate-100 rounded-xl p-4 border border-slate-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-sm font-medium text-slate-800">Mois le Plus Faible</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-4 border border-blue-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-sm font-medium text-blue-800">Jours Travaillés</p>
          </div>
          <p className="text-xl font-bold text-blue-900">{kpis.totalDaysWorked} jours</p>
          <div className="flex items-center gap-2 mt-1">
        ...
        <div className="bg-gradient-to-br from-purple-50 to-purple-100 rounded-xl p-4 border border-purple-200">
          <p className="text-sm font-medium text-purple-800 mb-2">Écart Moyen/Mois</p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4">
          <p className="text-sm font-medium text-slate-600 mb-1">CA Moyen Mensuel</p>
          <p className="text-xl font-bold text-slate-900">{formatCurrency(kpis.avgMonthlyRevenue)} F</p>
        </div>

        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4">
          <p className="text-sm font-medium text-slate-600 mb-1">Dépenses Moyennes Mensuelles</p>
          <p className="text-xl font-bold text-slate-900">{formatCurrency(kpis.avgMonthlyExpenses)} F</p>
        </div>

        <div className="bg-white rounded-xl shadow-sm border border-slate-200 p-4">
          <p className="text-sm font-medium text-slate-600 mb-1">Marge Brute Moyenne Mensuelle</p>
