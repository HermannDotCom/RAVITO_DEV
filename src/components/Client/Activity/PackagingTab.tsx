            ...
            >
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        {isEditing ? (
                          <input
                            ...
                            className="w-full min-h-[40px] px-2 py-2 border border-slate-300 rounded text-center text-sm"
                          />
                        ) : (
              ...
              {isEditing && (
                <div className="flex gap-2 mt-3">
                  <button
                    onClick={() => handleSave(pkg.id)}
                    className="flex-1 min-h-[44px] px-3 py-2.5 bg-green-600 text-white rounded-lg text-sm font-medium hover:bg-green-700"
                  >
                    Sauvegarder
                  </button>
                  <button
                    onClick={handleCancel}
                    className="flex-1 min-h-[44px] px-3 py-2.5 bg-slate-300 text-slate-700 rounded-lg text-sm font-medium hover:bg-slate-400"
                  >
                    Annuler
                  </button>
                </div>
