        ...
        {isFrozenOrDisabled ? (
          <>
            <button
              ...
              disabled={isReadOnly}
              className="flex items-center justify-center gap-1 px-2 py-2.5 min-h-[44px] bg-green-500 text-white text-sm font-medium rounded-lg hover:bg-green-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
            ...
            {onUnfreeze && customer.status !== 'disabled' ? (
              <button
                ...
                disabled={isReadOnly}
                className="flex items-center justify-center gap-1 px-2 py-2.5 min-h-[44px] bg-blue-500 text-white text-sm font-medium rounded-lg hover:bg-blue-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
              ...
              <button
                ...
                className="flex items-center justify-center gap-1 px-2 py-2.5 min-h-[44px] bg-slate-500 text-white text-sm font-medium rounded-lg hover:bg-slate-600 transition-colors"
              >
            ...
            {onUnfreeze && customer.status !== 'disabled' && (
              <button
                onClick={() => onViewDetails(customer)}
                className="col-span-2 flex items-center justify-center gap-1 px-2 py-2.5 min-h-[44px] bg-slate-500 text-white text-sm font-medium rounded-lg hover:bg-slate-600 transition-colors"
              >
                <Eye className="w-4 h-4 flex-shrink-0" />
                <span>Détails</span>
              </button>
          ...
          <>
            <button
              ...
              disabled={isReadOnly}
              className="flex items-center justify-center gap-1 px-2 py-2.5 min-h-[44px] bg-orange-500 text-white text-sm font-medium rounded-lg hover:bg-orange-600 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
            >
            ...
            <button
              onClick={() => onViewDetails(customer)}
              className="col-span-2 flex items-center justify-center gap-1 px-2 py-2.5 min-h-[44px] bg-blue-500 text-white text-sm font-medium rounded-lg hover:bg-blue-600 transition-colors"
            >
              <Eye className="w-4 h-4 flex-shrink-0" />
              <span>Détails</span>
            </button>
