...
import { ClipboardList, Calendar, CheckCircle, XCircle, Settings } from 'lucide-react';
        ...
        <div className="mb-6">
          <div className="flex items-center justify-between gap-3 mb-4">
            ...
            <button 
              ...
              title="Configurer mes produits"
            >
              <Settings className="w-5 h-5" />
              <span className="hidden sm:inline text-sm font-medium">Configurer</span>
            </button>
          </div>
