  ...
  return (
    <div className="space-y-4 sm:space-y-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <h2 className="text-lg sm:text-xl font-bold text-slate-900">Synthèse de la Journée</h2>
      </div>
      ...
      {isReadOnly ? (
          ...
          <div className="bg-green-50 border-2 border-green-300 rounded-xl p-3 sm:p-4">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
              <div className="flex items-center gap-3">
                <Lock className="w-6 h-6 sm:w-8 sm:h-8 text-green-600 flex-shrink-0" />
                <div>
                  <h3 className="font-bold text-green-900 text-base sm:text-lg">Journée clôturée</h3>
            ...
            <div className="bg-blue-50 border-2 border-blue-200 rounded-xl p-3 sm:p-4">
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  <h3 className="font-bold text-blue-900 text-sm sm:text-base mb-2">Notes de clôture</h3>
                  <p className="text-xs sm:text-sm text-blue-800 whitespace-pre-wrap break-words">{sheet.notes}</p>
                </div>
              </div>
            </div>
          )}
        ...
        <div className="bg-amber-50 border-2 border-amber-300 rounded-xl p-3 sm:p-4">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h3 className="font-bold text-amber-900 text-base sm:text-lg">Journée en cours</h3>
      ...
      {/* Summary cards */}
      <div className={`grid gap-3 sm:gap-4 ${isReadOnly && sheet?.closingCash !== null ? 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-5' : 'grid-cols-1 sm:grid-cols-2 lg:grid-cols-3'}`}>
        {/* Revenue card */}
        <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-3 sm:p-4 border-2 border-green-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-xs sm:text-sm font-medium text-green-800">CA Théorique</p>
          </div>
        ...
        {/* Expenses card */}
        <div className="bg-gradient-to-br from-red-50 to-red-100 rounded-xl p-3 sm:p-4 border-2 border-red-200">
          <div className="flex items-center gap-2 mb-2">
            <TrendingDown className="w-4 h-4 sm:w-5 sm:h-5 text-red-600" />
            <p className="text-xs sm:text-sm font-medium text-red-800">Dépenses</p>
          </div>
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 rounded-xl p-3 sm:p-4 border-2 border-blue-200">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-xs sm:text-sm font-medium text-blue-800">{isReadOnly ? 'Caisse Finale Théorique' : 'Caisse Attendue'}</p>
          </div>
        ...
        {isReadOnly && sheet?.closingCash !== null && (
          <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-xl p-3 sm:p-4 border-2 border-green-200">
            <div className="flex items-center gap-2 mb-2">
              ...
              <p className="text-xs sm:text-sm font-medium text-green-800">Caisse Finale Réelle</p>
            </div>
            <p className="text-xl sm:text-2xl font-bold text-green-900">
        ...
        {isReadOnly && sheet?.closingCash !== null && (
          <div className={`bg-gradient-to-br rounded-xl p-3 sm:p-4 border-2 ${
      ...
      {sheet && ((sheet.creditSales || 0) > 0 || (sheet.creditPayments || 0) > 0 || (sheet.creditBalanceEod || 0) > 0) && (
        <div className="bg-orange-50 border-2 border-orange-200 rounded-xl p-3 sm:p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm sm:text-base font-bold text-orange-900">💳 Crédits du Jour</h3>
          </div>
          <div className="space-y-2">
            <div className="flex items-center justify-between p-2 bg-white rounded text-xs sm:text-sm">
              <span className="text-slate-700">Crédits accordés:</span>
              <span className="font-medium text-orange-600">
                {formatCurrency(sheet.creditSales || 0)} FCFA
              </span>
            </div>
            <div className="flex items-center justify-between p-2 bg-white rounded text-xs sm:text-sm">
              <span className="text-slate-700">Règlements reçus:</span>
              <span className="font-medium text-green-600">
                {formatCurrency(sheet.creditPayments || 0)} FCFA
              </span>
            </div>
            <div className="flex items-center justify-between p-2 bg-white rounded border border-orange-300 text-xs sm:text-sm">
              <span className="font-medium text-slate-900">Solde crédit total:</span>
      ...
      {(calculations.packagingAlerts.length > 0 || calculations.stockAlerts.length > 0) && (
        <div className="bg-red-50 border-2 border-red-200 rounded-xl p-3 sm:p-4">
          <div className="flex items-center gap-2 mb-3">
            ...
            <h3 className="text-sm sm:text-base font-bold text-red-900">Alertes</h3>
          </div>
      ...
      {!isReadOnly && (
        <div className="bg-white border-2 border-slate-200 rounded-xl p-3 sm:p-4">
          <h3 className="text-sm sm:text-base font-bold text-slate-900 mb-3">État de Complétude</h3>
          <div className="space-y-2">
            <div className="flex items-center justify-between p-2 bg-slate-50 rounded text-xs sm:text-sm">
              <span className="text-slate-700">Stocks finaux saisis</span>
              <span
            ...
            <div className="flex items-center justify-between p-2 bg-slate-50 rounded text-xs sm:text-sm">
              <span className="text-slate-700">Casiers comptés</span>
              <span
                className={`font-medium ${
            ...
            <div className="flex items-center justify-between p-2 bg-slate-50 rounded text-xs sm:text-sm">
              <span className="text-slate-700">Dépenses enregistrées</span>
              <span className="font-medium text-blue-600">{expenses.length}</span>
            </div>
          </div>
        </div>
      )}
      ...
      {!isReadOnly && !showCloseConfirm && (
        <div className="bg-gradient-to-br from-amber-50 to-amber-100 border-2 border-amber-300 rounded-xl p-4 sm:p-6">
          <h3 className="font-bold text-amber-900 text-base sm:text-lg mb-2 sm:mb-3">Clôturer la Journée</h3>
          ...
          <button
            ...
            disabled={!canClose}
            className="w-full px-4 sm:px-6 py-2 sm:py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 font-bold text-base sm:text-lg disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:from-green-600 disabled:hover:to-green-700"
          >
      ...
      {showCloseConfirm && !isReadOnly && (
        <div className="bg-white border-2 border-green-300 rounded-xl p-4 sm:p-6">
          <h3 className="font-bold text-slate-900 text-base sm:text-lg mb-4">Confirmer la Clôture</h3>
          ...
          <div className="space-y-4 mb-6">
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-3 sm:px-4 py-2 sm:py-3 border-2 border-slate-300 rounded-lg text-base sm:text-lg font-medium focus:ring-2 focus:ring-green-500 focus:border-green-500"
                autoFocus
              />
            ...
            <div>
              ...
              <textarea
                ...
                rows={3}
                className="w-full px-3 py-2 border border-slate-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-green-500 text-xs sm:text-sm"
              />
            </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <button
              ...
              disabled={closing}
              className="flex-1 px-4 py-2 sm:py-3 bg-slate-200 text-slate-700 rounded-lg hover:bg-slate-300 font-medium text-sm sm:text-base"
            >
              Annuler
            </button>
            <button
              ...
              className="flex-1 px-4 py-2 sm:py-3 bg-gradient-to-r from-green-600 to-green-700 text-white rounded-lg hover:from-green-700 hover:to-green-800 font-bold disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
            >
