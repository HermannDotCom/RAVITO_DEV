  ...
  return (
    <div className="max-w-4xl mx-auto p-4 sm:p-6 pb-20 lg:pb-6">
      <div className="mb-6 sm:mb-8">
        <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-2">Mon Panier</h1>
      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 overflow-hidden">
                ...
                <div className="flex-1 min-w-0">
                  <div className="flex justify-between items-start mb-2">
                    ...
                    <button
                      ...
                      className="p-2 min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0 text-red-500 hover:text-red-700 hover:bg-red-50 rounded-full transition-colors flex-shrink-0"
                  ...
                  <div className="space-y-3">
                      ...
                      <div className="flex items-center space-x-4">
                        <div className="flex items-center space-x-2">
                          <button
                            ...
                            className="h-11 w-11 sm:h-8 sm:w-8 rounded-full bg-gray-100 flex items-center justify-center hover:bg-gray-200 transition-colors min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0"
                          >
                            -
                          </button>
                          ...
                          <button
                            ...
                            className="h-11 w-11 sm:h-8 sm:w-8 rounded-full bg-orange-100 flex items-center justify-center hover:bg-orange-200 transition-colors min-h-[44px] min-w-[44px] sm:min-h-0 sm:min-w-0"
                          >
                            +
                          </button>
                        </div>
                        ...
                        <div className="flex items-center">
                          <label className="flex items-center space-x-2 cursor-pointer">
                            <input
                              ...
                              className="h-5 w-5 sm:h-4 sm:w-4 text-orange-600 focus:ring-orange-500 border-gray-300 rounded"
                            />
                    ...
                    {!item.withConsigne && (
                      <div className="flex items-center space-x-2 text-xs bg-blue-50 text-blue-700 p-2 rounded">
        ...
        <div className="border-t border-gray-200 bg-gray-50 p-4 sm:p-6 space-y-4">
          ...
          <button
            onClick={onCheckout}
            className="w-full bg-gradient-to-r from-orange-500 to-orange-600 text-white py-4 rounded-lg font-semibold hover:from-orange-600 hover:to-orange-700 transition-all text-base sm:text-lg min-h-[48px]"
          >
