 ...
 * Allows clients to request withdrawals from their wallet
 */
        ...
        <form onSubmit={handleSubmit} className="p-6">
          ...
          <div className="bg-orange-50 border border-orange-200 rounded-xl p-4 mb-6">
            <div className="flex items-center justify-between">
              <span className="text-sm text-orange-800">Solde disponible</span>
              <span className="text-xl font-bold text-orange-900">{formatCurrency(balance)}</span>
            </div>
          </div>
          ...
          <div className="mb-6 space-y-4">
            <div>
              ...
              <input
                ...
                className="w-full border-2 border-gray-200 rounded-xl p-3 focus:border-orange-500 focus:ring-0 outline-none"
                disabled={isProcessing}
              />
            </div>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-xl p-4 mb-6">
            <div className="flex gap-3">
              ...
              <div className="text-sm text-blue-800">
                ...
                <p>
                  Votre demande sera traitée sous 24 heures (simulation MVP). 
