    ...
    <div className="p-8 max-w-6xl mx-auto">
        ...
        <div className="bg-gradient-to-br from-blue-50 to-blue-100 p-6 rounded-xl border border-blue-200">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-blue-700 mt-1">{tickets.length}</p>
            </div>
      ...
      {!showCreateForm && (
        <button
          ...
          className="mb-6 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors flex items-center space-x-2"
        >
            ...
            {tickets.map((ticket) => (
              ...
              >
                ...
                <button
                  ...
                  className="px-4 py-2 bg-blue-100 text-blue-700 hover:bg-blue-200 rounded-lg font-medium transition-colors flex items-center space-x-2"
                >
