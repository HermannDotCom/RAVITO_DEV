...
6. Vérifier le **splash screen** au démarrage (logo avec slogan sur fond blanc)

**Sur Android (Chrome)** :
1. Ouvrir l'application dans Chrome
2. Appuyer sur le menu (3 points)
3. Sélectionner "Installer l'application"
4. Vérifier que la **nouvelle icône** s'affiche sur l'écran d'accueil
5. Lancer l'application
6. Vérifier le **splash screen** au démarrage
...
3. Vider le cache du CDN (si applicable)
...
2. **Forcer le rechargement pour les utilisateurs** :
...
4. Si le problème persiste, vérifier que les fichiers favicon sont bien déployés

### Problème : Le splash screen iOS ne s'affiche pas

**Solution** :
1. Désinstaller l'application de l'écran d'accueil
2. Vider le cache de Safari (Réglages > Safari > Effacer historique et données)
3. Réinstaller l'application
4. Vérifier que les fichiers `splash-*.png` sont bien déployés

### Problème : Les logos sont flous ou pixelisés

**Solution** :
1. Vérifier que les fichiers PNG haute résolution sont utilisés
2. Vérifier les classes CSS `className` pour la taille des logos
3. Utiliser des versions SVG si possible (pour le logo sans slogan)
